        ...
        children: [
          Row(
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                    color: statusColor(selectedInfoWindow!.status.validate()).withValues(alpha:0.08), borderRadius: BorderRadius.circular(6)),
              ...
              Container(
                decoration: BoxDecoration(
                    color: statusColor(selectedInfoWindow!.title.validate()).withValues(alpha:0.08), borderRadius: BorderRadius.circular(6)),
                padding: .symmetric(horizontal: 8, vertical: 6),
                child: Text(
