...
class OrderAmountDataWidget extends StatefulWidget {
  ...
  final double? perWeightCharge;
  final double? perkmVehiclePrice;
  final double? perKmCityDataCharge;
...
class OrderAmountDataWidgetState extends State<OrderAmountDataWidget> {
  ...
  void initState() {
    super.initState();
    print("perkmVehiclePrice => ${widget.perkmVehiclePrice}");
          ...
          widget.coupon != null
              ? Row(
                  ...
                  children: [
                    ...
                    Text(printAmount(widget.totalAmount! - calculateTotalAmount()), style: boldTextStyle(color: darkRed))
                  ],
