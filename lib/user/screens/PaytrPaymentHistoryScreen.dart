              ...
              ? AnimatedListView(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return Container(
                      ...
                      padding: .all(8),
                      decoration: boxDecorationWithRoundedCorners(borderRadius: radius(defaultRadius), backgroundColor: Colors.transparent, border: Border.all(color: ColorUtils.colorPrimary.withValues(alpha:0.08))),
                      child: Row(
                        children: [
                          10.width,
                          Expanded(
