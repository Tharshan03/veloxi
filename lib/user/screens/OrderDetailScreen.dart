...
class OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  orderDetailApiCall() async {
    ...
    await getOrderDetails(widget.orderId)
        .then((value) {
  ...
  cancelOrderByDeliveryManApiCall() async {
    appStore.setLoading(true);
    await updateOrder(orderId: widget.orderId, reason: reason == isOtherOptionSelected ? otherReason : reason, orderStatus: ORDER_CANCELLED)
        .then((value) {
        ...
        return AlertDialog(
          ...
          title: Column(
            children: [
              ...
              10.height,
              Divider(height: 1, thickness: 1, color: Colors.grey.withValues(alpha:0.5)),
            ],
          ),
          content: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: .spaceBetween,
                children: [
                  Text("${language.contactPersonName} :", style: secondaryTextStyle()).expand(),
                  Text(name, style: boldTextStyle(), overflow: TextOverflow.ellipsis, maxLines: 2).expand(),
                ],
              ),
              4.height,
              Row(
                ...
                children: [
                  ...
                  Text(instruction, style: boldTextStyle(), overflow: TextOverflow.ellipsis, maxLines: 3).expand(),
                ],
              ),
            ],
          ),
              ...
              ? Stack(
                  children: [
                        ...
                        Column(
                          ...
                          children: [
                            AppButton(
                              ...
                              onTap: () {
                                Reviewscreen(userData: userData, orderData: orderData).launch(context).then((value) async {
                                  if (value != null && value) {
                                    await init();
                                  }
                                });
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          ).cornerRadiusWithClipRRect(60).visible(!userData!.profileImage.isEmptyOrNull),
                                    ...
                                    children: [
                                      ...
                                      Container(
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(color: statusColor(orderData!.status.validate()).withValues(alpha:0.08)),
                                            ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      if (orderData!.reScheduleDateTime != null)
                                        Text(
                                          '${language.note} ${language.rescheduleMsg} ${DateFormat('yyyy-MM-dd').format(DateTime.parse(orderData!.reScheduleDateTime!))} ',
                                          style: secondaryTextStyle(color: Colors.red, size: 12),
                                        ).paddingOnly(top: 4),
                                    ],
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Icon(Icons.info, color: appStore.isDarkMode ? Colors.white.withValues(alpha:0.7) : ColorUtils.colorPrimary).onTap(() {
                                  ...
                                  Wrap(
                                    ...
                                    children: packagingSymbols.map((item) {
                                      return Container(
                                        ...
                                        decoration: boxDecorationWithRoundedCorners(
                                          backgroundColor: Colors.transparent,
                                          border: Border.all(color: ColorUtils.colorPrimary.withValues(alpha:0.4)),
                                        ),
                                        child: Stack(
                                          children: [
                                            Image.asset(
                                              ...
                                              width: 24,
                                              height: 24,
                                              color: appStore.isDarkMode ? Colors.white.withValues(alpha:0.7) : ColorUtils.colorPrimary,
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment: .spaceBetween,
                                children: [Text(orderData!.pickupPoint!.description.toString(), style: boldTextStyle(size: 14), maxLines: 3, overflow: TextOverflow.ellipsis).expand()],
                              ),
                            ).visible(!orderData!.pickupPoint!.description.isEmptyOrNull),
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment: .spaceBetween,
                                children: [Text(orderData!.deliveryPoint!.description.toString(), style: boldTextStyle(size: 14), maxLines: 3, overflow: TextOverflow.ellipsis).expand()],
                              ),
                            ).visible(!orderData!.deliveryPoint!.description.isEmptyOrNull),
                                        ...
                                        children: [
                                          if (vehicleDataitle != "")
                                            Container(
                                              ...
                                              child: Text(vehicleDataitle, style: primaryTextStyle(), maxLines: 4, overflow: TextOverflow.ellipsis),
                                            ),
                                        ],
                                      ),
                                    ),
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Text(
                                                          orderData!.status == COMPLETED ? ' ${userData!.name.validate().substring(0, 3)}XXXX' : '${userData!.name.validate()}',
                                                          style: boldTextStyle(),
                                                        ),
                                                        4.width,
                                                        if (getStringAsync(USER_TYPE) == CLIENT && !userData!.documentVerifiedAt.isEmptyOrNull) Icon(Octicons.verified, color: Colors.green, size: 18),
                            ...
                            Text(language.reason, style: boldTextStyle(size: 16)).visible(
                              getStringAsync(USER_TYPE) == DELIVERY_MAN &&
                                  (orderData!.status == ORDER_ACCEPTED || orderData!.status == ORDER_PICKED_UP || orderData!.status == ORDER_ARRIVED || orderData!.status == ORDER_DEPARTED),
                            ),
                            8.height,
                            ...
                            if (orderData!.status == ORDER_CANCELLED && payment != null)
                              Container(
                                width: context.width(),
                                decoration: BoxDecoration(
                                  color: appStore.isDarkMode ? ColorUtils.scaffoldSecondaryDark : ColorUtils.colorPrimary.withValues(alpha:0.1),
                                  borderRadius: BorderRadius.circular(8),
                                ),
                                padding: .all(12),
                                child: Text(
                            ...
                            Align(
                              ...
                              child: commonButton("Check for Bid", () {
                                Bidlistscreen(orderData: orderData).launch(context);
                              }, width: context.width()),
                            ...
                            Align(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    width: context.width(),
                                    decoration: BoxDecoration(color: appStore.isDarkMode ? scaffoldSecondaryDark : ColorUtils.colorPrimary.withValues(alpha:0.1), borderRadius: BorderRadius.circular(8)),
                                    padding: .all(12),
                          ...
                          Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(top: 0, right: 0, bottom: 0, left: 0, child: Icon(Icons.chat_bubble_outline, size: 25, color: white)),
                              ],
                            ),
                          ).onTap(() {
                    ...
                    Positioned(
                      ...
                      (orderData!.status == ORDER_PICKED_UP || orderData!.status == ORDER_ARRIVED || orderData!.status == ORDER_DEPARTED) &&
                          ((getStringAsync(USER_TYPE) == CLIENT) && orderData!.isClaimed == 0 && isUserEligibleForClaim == true),
                    ),
                  ],
                )
              : SizedBox(),
  ...
  Future<void> pickFiles() async {
    FilePickerResult? result = await FilePicker.platform.pickFiles(allowMultiple: true, type: FileType.custom, allowedExtensions: ['jpg', 'jpeg', 'png', 'pdf']);
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                6.width,
                                commonButton(language.addProofs, size: 14, () async {
                                  if (selectedFiles != null) selectedFiles!.clear();
                                  FilePickerResult? result = await FilePicker.platform.pickFiles(allowMultiple: true, type: FileType.custom, allowedExtensions: ['jpg', 'jpeg', 'png', 'pdf']);
                                  if (result != null) {
